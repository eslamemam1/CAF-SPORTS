    ...
    <div className=" flex flex-col sm:flex-row">
      <div className="w-full sm:w-[50%] h-[100px] bg-gray-800">
        <div className=" flex justify-center items-center h-[100px]">
          <span className=" font-semibold text-4xl sm:text-5xl pr-2 text-white"><NumberCounter targetNumber={10} /> </span>
      ...
      <div className="w-full sm:w-[50%] h-[100px] bg-[#00a44f]">
        <div className=" flex justify-center items-center h-[100px]">
          <span className=" font-semibold text-4xl sm:text-5xl pr-2 text-white"><NumberCounter targetNumber={200} /></span>
